...
const Home = ({ navigation }) => {
  const initialCurrentLocation = {
    streetName: "Kuching",
    gps: {
      latitude: 13.081230853911661,
      longitude: 80.2719561248615,
    },
  };
  ...
  const restaurantData = [
    {
      ...
      duration: "30 - 45 min",
      location: {
        latitude: 13.082413999437517,
        longitude: 80.28183164793228,
      },
      courier: {
  ...
  function onSelectCategory(category) {
    let restaurant = restaurantData.filter((a) =>
  ...
  function renderRestaurentItems() {
  ...
  function renderMainCategory() {
    ...
    return (
      <View style={{ padding: SIZES.padding * 2 }}>
        ...
        <Text style={{ ...FONTS.h1 }}>Cagegory</Text>
        <FlatList
          data={categories}
          horizontal
